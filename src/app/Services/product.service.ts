...
get Refresh()
{
  ...
  getall(): Observable<Iproduct[]> {
    return this.httpclient.get<Iproduct[]>(
      `https://localhost:44380/api/Product/Index`
    );
  }
  ...
  getallproofcat(Id: number): Observable<Iproduct[]> {
    return this.httpclient.get<Iproduct[]>(
      `https://localhost:44380/api/Product/productscatagorybyId/${Id} `
    );
  }
  ...
  addProduct(newPrd: Iproduct): Observable<Iproduct> {
    return this.httpclient
      .post<Iproduct>(
        `https://localhost:44380/api/Product/adding `,
  ...
  updateProduct(prdID: number, UpdatedPrd: Iproduct): Observable<Iproduct> {
    return this.httpclient
      .put<Iproduct>(
        `https://localhost:44380/api/Product/edite/${prdID} `,
  ...
  addToCart(Id: number): Observable<any> {
    return this.httpclient
      .post<any>(
        `https://localhost:44380/api/Cart/Additem?Product_Id=${Id}`,
        Id,
        this.httpOption
      )
  }
  getcounter(): Observable<number> {
    return this.httpclient.get<number>(
      `https://localhost:44380/api/Cart/GetTotalItemInCart`,
      this.httpOption
    );
